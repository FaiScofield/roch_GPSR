...
// const char* FileName = "/home/ubuntu/gpsr_ws/src/roch_GPSR/roch_tts/wav/tts_sample.wav"; //合成的语音文件名称
// const char* PlayPath = "play /home/ubuntu/gpsr_ws/src/roch_GPSR/roch_tts/wav/tts_sample.wav";
...
{
    ros::init(argc, argv, "roch_tts_1");
    ros::NodeHandle n;
    ros::Subscriber sub = n.subscribe("/roch/voice/tts_words", 1, TTSCallback);
